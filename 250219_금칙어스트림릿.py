...
word_listf = [
    ...
    '찾아서', '첫달', '추후', '치고는', '치워', '쿠퍼의', '탈당', '트기', '티플', '필히', '후과', '히동',
...
if menu == "금칙어검사":
    ...
    def wrap_text(text, max_chars, apply_keyword_replacement=True):
        ending_phrases = ["습니다", "니다", "죠", "데요", "군요", "네요", "세요", "입니까", "돼요", "겠습니다", "십시오",
                          "하죠", "해요", "됩니다", "입니다", "이에요", "예요", "라고요", "이라고요", "다고요", "겠죠",
                          "되겠습니다", "하겠습니다", "하십시오", "갑니다", "봅니다", "집니다", "랍니다", "었습니다", "었죠",
                          "했어요", "하죠", "해보세요", "해봅시다", "할까요", "할게요", "드릴게요", "있어요", "말이에요",
                          "말입니다", "니까요", "이죠", "잖아요", "그래요", "라고요", "이라고요", "라고 하더라고요", "라고 했어요",
                          "라니까요", "이라니까요", "갑시다", "봅시다", "집시다", "랍시다", "었습니까", "했습니까",
                          "하겠습니까", "하시겠습니까", "되었어요", "거든요", "었어요", "데요", "셨어요", "되었죠",
        ...
        # 치환된 텍스트를 단어 단위로 쪼개어 줄바꿈을 적용합니다.
        words = text.split()
        wrapped = ''
        current_line = ''
